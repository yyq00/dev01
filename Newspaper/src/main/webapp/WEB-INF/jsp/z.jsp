...
<div class="rail">
    <div class="stamp four">刊</div>
    <div class="stamp zero">报</div>
    <div class="stamp four">统</div>
    <div class="stamp zero">系</div>
    <div class="stamp four">理</div>
    <div class="stamp zero">管</div>
    <div class="stamp four">刊</div>
    <div class="stamp zero">报</div>
    <div class="stamp four">统</div>
    <div class="stamp zero">系</div>
