...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">${Qname.userName}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/user/a">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>信息修改</cite>
                        </a>
                    </li>
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <div class="cen aa">
                    <br>
                    <br>
                    <p style="transform: rotate(-45deg);font-size: 15px;color: white">欢迎您:${Qname.userName}</p>
                </div>
                <div class="cen bb">
                </div>
                <div class="cen cc">
